const Hterminal = document.getElementById("terminal") as HTMLElement
const response = document.getElementById("response") as HTMLTextAreaElement
...
class Terminal {
    ...
    executar(script: string) {
        ...
        let res: string = "command not found"
